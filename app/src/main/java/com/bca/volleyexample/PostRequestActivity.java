    ...
    private void postDataUsingVolley(String name, String job) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(PostRequestActivity.this, "Data added to API", Toast.LENGTH_SHORT).show();
                try {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PostRequestActivity.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
